...
class StudentForm(forms.Form):
	...
	skillsKnown = forms.CharField(label='Known skills (separated by spaces)', required=False)
	skillsDesired = forms.CharField(label='Skills desired (separated by spaces)', required=False)
	langsKnown = forms.CharField(label='Known languages (separated by spaces)', required=False)
	langsDesired = forms.CharField(label='Languages desired (separated by spaces)', required=False)
